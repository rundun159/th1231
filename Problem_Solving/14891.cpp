...
#define A_NUM 4
#define A_SIZE 8
typedef vector<int> A; //��Ϲ���
typedef vector<A> V_A; //��Ϲ��� arr
int k;
...
void rotate(A& a, int r)	//r : rotate ����. 1 : �ð�, -1 : �ݽð�, 0 �ȿ�����
{
	A temp= A(8);
	if (r == 0)
	{
...
int ret_Rotate_from_Right(const A& a1, const A& a2, int r) //r : ȸ�� ���� of a2
{
...
int ret_Rotate_from_Left(const A& a1, const A& a2, int r) //r : ȸ�� ���� of a1
{
	int RIGHT_IDX = 6, LEFT_IDX = 2;
	if (r == 0)
		return 0;
