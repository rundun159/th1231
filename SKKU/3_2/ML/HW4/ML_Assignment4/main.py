...
# Add layers
CNN.add_layer('Conv-1',ConvolutionLayer(in_channels=in_channels,out_channels=4, kernel_size=3,stride=1,pad=1))
CNN.add_layer('ReLU-1',ReLU())
CNN.add_layer('Conv-2',ConvolutionLayer(in_channels=4,out_channels=4, kernel_size=3,stride=1,pad=1))
...
##################################################################
epochs =list(np.arange(1,11))
plt.plot(epochs, list(train_acc), label='Train Acc.')
plt.plot(epochs, list(valid_acc), label='Valid Acc.')
