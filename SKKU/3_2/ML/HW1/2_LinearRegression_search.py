...
"""
plt.plot(_batch_size,train_results,linestyle='-',color='b',label='train',marker='o')
plt.plot(_batch_size,test_results,linestyle='-',color='r',label='test',marker='o')
plt.xlabel('Batch size')
plt.ylabel('RMSE')
plt.xticks(_batch_size,_batch_size)
plt.title('Linear_Regression_search')
plt.legend()
plt.show()
# ============================================================