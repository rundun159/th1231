...
%token <ptr> INT
%token <ptr> FLOAT
%token <ptr> EOL OPENA OPENB OPENC CLOSEA CLOSEB CLOSEC OPEND CLOSED IS IN listOf setOf
%token <ptr> AND OR
	...
	statement
{
	...
	|	statement body
{
	struct Node * newNode = makeNewNode("BODY","STATEMENT BODY",$1->dataType,$1->data);
		makechildArr(newNode,2);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		$$=newNode;
		...
		exprStatement  Arrow  STRING
{
	...
	|	ELSE  Arrow  STRING
{
	struct Node * newNode = makeNewNode("WHEN_STATEMENT","ELSE  Arrow  STRING",$2->dataType,$2->data);
		makechildArr(newNode,3);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("WHEN_STATEMENT","ELSE  Arrow  funStatement",$2->dataType,$2->data);
		makechildArr(newNode,3);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
		struct Node * newNode = makeNewNode("WHEN_STATEMENT","NotBlock  IS  LIST_STATEMENT  Arrow  funStatement",$2->dataType,$2->data);
		makechildArr(newNode,5);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
}	|	ELSE  Arrow  funStatement
{
	struct Node * newNode = makeNewNode("WHEN_STATEMENT","ELSE  Arrow  funStatement",$2->dataType,$2->data);
		...
		$$=newNode;
		printNode(newNode);
}	|	ELSE  Arrow  retStatement
{
	struct Node * newNode = makeNewNode("WHEN_STATEMENT","ELSE  Arrow  retStatement",$2->dataType,$2->data);
		makechildArr(newNode,3);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
		$$=newNode;
		printNode(newNode);
}	|	exprStatement  Arrow  retStatement
{
	struct Node * newNode = makeNewNode("WHEN_STATEMENT","EXPR_STATEMENT ARROW retStatement",$2->dataType,$2->data);
		makechildArr(newNode,3);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
;
setStatement:
	setOf OPENC par CLOSEC
{
	struct Node * newNode = makeNewNode("SET_STATEMENT","SETOf OPENC par CLOSEC",$3->dataType,$3->data);
		makechildArr(newNode,4);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("LIST_STATEMENT","LISTOF (PAR)",$3->dataType,$3->data);
		makechildArr(newNode,4);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("IS_IN_STATEMENT","exprStatement NotBlock IS exprStatement",$3->dataType,$3->data);
		makechildArr(newNode,4);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("IS_IN_STATEMENT","exprStatement NotBlock IN exprStatement",$3->dataType,$3->data);
		makechildArr(newNode,4);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("IS_IN_STATEMENTMENT","exprStatement NotBlock IS TYPES",$3->dataType,$3->data);
		makechildArr(newNode,4);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
defStatement:	  
	funDefStatement
{
	struct Node * newNode = makeNewNode("DEF_STATEMENT","FUN_DEF_STATEMENT",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
	...
	| varDefStatement
{
	struct Node * newNode = makeNewNode("DEF_STATEMENT","VAR_DEF_STATEMENT",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
	...
	| valDefStatement
{
	struct Node * newNode = makeNewNode("DEF_STATEMENT","VAL_DEF_STATEMENT",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
		...
		ID OPENC exprStatement CLOSEC
{
	...
	|	ID OPENC exprStatement CLOSEC COMMA parentBlock2
		{
	struct Node * newNode = makeNewNode("PARENT_BLOCK2","ID OPENC exprStatement CLOSEC COMMA parentBlock2",$1->dataType,$1->data);
	...
	|	ID
{
	struct Node * newNode = makeNewNode("PARENT_BLOCK2","ID",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
	...
	|valDefStatement	
{
	struct Node * newNode = makeNewNode("PARENT_BLOCK2","val_def_state",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
...
{
	struct Node * newNode = makeNewNode("PARENT_BLOCK2","ID COMMA PARENT_BLOCK2",$1->dataType,$1->data);
		makechildArr(newNode,3);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("FUN_DEF_STATEMENT","fun  ID  OPENC  defPar  CLOSEC  funTypeBlock  funAssnBlock",$1->dataType,$1->data);
		makechildArr(newNode,7);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
assnBlock:
	ASSN assnBlock2
{
	struct Node * newNode = makeNewNode("ASSN_BLOCK","ASSN ASSN_BLOCK2",$2->dataType,$2->data);
		makechildArr(newNode,2);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		$$=newNode;
...
assnBlock2:
	exprStatement
{
	struct Node * newNode = makeNewNode("ASSN_BLOCK2","EXPRSTATEMENT",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
	...
	| branchStatement
{
	struct Node * newNode = makeNewNode("ASSN_BLOCK2","BRANCH_STATE",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
	...
	| OPENA  BodySet  CLOSEA
{
	...
	|  assnBlock
{
		struct Node * newNode = makeNewNode("FUNASSNBLOCK","assnBlock",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
...
{
	struct Node * newNode = makeNewNode("VARDEFSTATEMENT","overrideBlock VAR  ID varDefBlock1 varDefBlock2",$2->dataType,$2->data);
		makechildArr(newNode,5);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("VAL_DEF_STATEMENT","OVERRIDEBLOCK VAL ID ASSN_BLOCK",$4->dataType,$4->data);
		makechildArr(newNode,4);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("VAL_DEF_STATEMENT","OVERRIDEBLOCK VAL ID TYPE TYPES",$2->dataType,$2->data);
		makechildArr(newNode,5);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("VAL_DEF_STATEMENT","OVERRIDEBLOCK VAL ID TYPE TYPES ASSN_BLOCK",$5->dataType,$5->data);
		makechildArr(newNode,6);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
...
{
	struct Node * newNode = makeNewNode("VALDEFSTATEMENT","OVERRIDEBLOCK VAL ID TYPE TYPE TYPES GET ASSN_BLOCK",$2->dataType,$2->data);
	...
	|	exprStatement LESS exprStatement 
{
	...
	|	ID DOT funStatement
	{
	struct Node * newNode = makeNewNode("BINARY_OPSTATEMNET","ID DOT FUNSTATEMENT",$2->dataType,$2->data);
		makechildArr(newNode,3);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
    ...
    |   unaryOpStatement
{
    ...
    |	is_in_Statement {
	struct Node * newNode = makeNewNode("EXPR","IS_IN_STATEMENT",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
    ...
    |	listStatement 
{
	struct Node * newNode = makeNewNode("EXPR","LIST_STATEMENT",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
    ...
    |	setStatement 
{
	struct Node * newNode = makeNewNode("EXPR","SET_STATEMENT",$1->dataType,$1->data);
		makechildArr(newNode,1);
		newNode->childArr[0]=$1;
		$$=newNode;
		printNode(newNode);
...
funStatement:
	ID OPENC  par  CLOSEC
{
	struct Node * newNode = makeNewNode("FUN_STATE","ID OPENC  par  CLOSEC",$1->dataType,$1->data);
		makechildArr(newNode,4);
		newNode->childArr[0]=$1;
		newNode->childArr[1]=$2;
		newNode->childArr[2]=$3;
